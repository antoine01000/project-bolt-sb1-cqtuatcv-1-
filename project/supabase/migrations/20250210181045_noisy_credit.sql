/*
  ...
  2. Modifications
    - Ajout de la colonne `description` à la table `cagnottes`
    - Ajout de la colonne `target_amount` aux tables `cagnottes` et `subcagnottes`

  3. Sécurité
    - Enable RLS sur la nouvelle table
    - Ajout des policies pour la gestion des sous-cagnottes
*/
